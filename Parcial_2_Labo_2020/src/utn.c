...
static int isCuitSoloNumeros(char cadena[]);
static int utn_IsValidSueldo(char array[], int limite);
static int isValidNumber(char array[], int limite);
...
int utn_getNumberTxt(char* pMensaje, char* pMensajeError, char* pResultado, int reintentos, int limite)
{
	...
	if(pMensaje != NULL && pMensajeError != NULL && pResultado != NULL && reintentos >= 0 && limite > 0)
	{
		do
		{
			...
			if(	(myGets(bufferString, LONG_NAME)== 0) &&
				(strnlen(bufferString, sizeof(bufferString)-1) < limite) &&
				(isValidNumber(bufferString, limite) != 0))
			{
				strncpy(pResultado, bufferString, limite);
				retorno = 0;
				break;
...
int utn_getHorasTxt(char* pMensaje, char* pMensajeError, char* pResultado, int reintentos, int limite)
{
	...
	if(pMensaje != NULL && pMensajeError != NULL && pResultado != NULL && reintentos >= 0 && limite > 0)
	{
		do
		{
			...
			if(	(myGets(bufferString, LONG_NAME)== 0) &&
				(strnlen(bufferString, sizeof(bufferString)-1) < limite) &&
				(utn_IsValidSueldo(bufferString, limite) != 0))
			{
				strncpy(pResultado, bufferString, limite);
				retorno = 0;
				break;
...
int utn_getCuitTxt(char* pMensaje, char* pMensajeError, char* pResultado, int reintentos, int limite)
{
	...
	if(pMensaje != NULL && pResultado != NULL && pMensajeError != NULL && reintentos >= 0 && limite > 0 )
	{
		do
		{
			...
			if(	(myGets(bufferString, LONG_NAME)== 0) &&
				(strnlen(bufferString, sizeof(bufferString)-1) <= limite) &&
				(isCuitSoloNumeros(bufferString)==1))
			{
				strncpy(pResultado, bufferString, limite);
				retorno = 0;
				break;
